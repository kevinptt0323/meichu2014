...
a.wrapInner('<div class="fp-scrollable" />'),a.find(".fp-scrollable").slimScroll({allowPageScroll:!0,height:b+"px",size:"10px",color:"#fff",distance:"55px",alwaysVisible:!0})):ea(a);a.css("overflow","")}function ea(a){a.find(".fp-scrollable").children().first().unwrap().unwrap();a.find(".slimScrollBar").remove();a.find(".slimScrollRail").remove()}function fa(a){a.addClass("fp-table").wrapInner('<div class="fp-tableCell" style="height:'+ga(a)+'px;" />')}function ga(a){var b=h;if(c.paddingTop||c.paddingBottom)b=a,b.hasClass("fp-section")||
